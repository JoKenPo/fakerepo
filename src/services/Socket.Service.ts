...
export const IOServer = (io: SocketIO.Server) => {
  ...
  io.on("connection", (socket) => {
    ...
    if (
      ...
      socket.handshake.headers.key = "dev.legisnote.com.br";
    ...
    socket.on(
      ...
      (
        ...
        IOSendToRoom(event, String(socket.handshake.headers.key), roomId, completeData);
      }
    );
